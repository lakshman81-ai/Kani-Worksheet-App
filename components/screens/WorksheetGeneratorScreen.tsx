            ...
            <div style={{
                ...
                <button
                    ...
                    style={{
                        ...
                        border: mode === 'ai' ? 'none' : '2px solid rgba(255,255,255,0.1)',
                        color: '#fff',
                        cursor: 'pointer',
                ...
                >
                    ...
                    <span style={{ fontSize: '16px', fontWeight: 700 }}>Generate with AI</span>
                    <p style={{ fontSize: '12px', opacity: 0.7, margin: '8px 0 0' }}>
                        Create new questions using Gemini AI
                    </p>
                </button>
                <button
                    ...
                    style={{
                        ...
                        padding: '20px',
                        borderRadius: '16px',
                        background: mode === 'sheet'
                            ? 'linear-gradient(135deg, #4caf50 0%, #2e7d32 100%)'
                            : 'rgba(255,255,255,0.08)',
                        border: mode === 'sheet' ? 'none' : '2px solid rgba(255,255,255,0.1)',
                        color: '#fff',
                        cursor: 'pointer',
                        transition: 'all 0.3s ease',
                    }}
                >
                    <span style={{ fontSize: '32px', display: 'block', marginBottom: '10px' }}>📊</span>
                    <span style={{ fontSize: '16px', fontWeight: 700 }}>Import from Sheet</span>
                    <p style={{ fontSize: '12px', opacity: 0.7, margin: '8px 0 0' }}>
                        Load existing questions from Google Sheet
                    </p>
                </button>
            </div>
            ...
            <div className={styles.generatorCard}>
                ...
                {generatedQuestions.length > 0 && (
                    <div style={{ marginTop: '20px' }}>
                        ...
                        {/* Export Options */}
                        <div className={styles.formGroup}>
                            <label className={styles.formLabel}>📤 Export To</label>
                            <div className={styles.exportOptions}>
                                ...
                                >
                                    ...
                                    <span className={styles.exportOptionLabel}>Local CSV</span>
                                </div>
                                <div
                        ...
                        <div style={{ display: 'flex', gap: '15px', marginTop: '20px' }}>
                            ...
                            >
                                <span>📤</span>
                                <span>Export {exportType === 'csv' ? 'CSV' : 'to Sheet'}</span>
                            </button>
                            <button
                                className={styles.settingsBackBtn}
                                onClick={resetForm}
