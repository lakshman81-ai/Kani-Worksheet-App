...
```csv
Question,Answer A,Answer B,Answer C,Answer D,Correct Answer,Hint,Know More Description,Know More Link,YouTube URL,Image URL,Type,Concept,Worksheet No.
"Who took Lily and Max on their space trip?","Captain Star","Emma","Jake","Columbus","A","Read the story carefully.","Learn about Space","https://wikipedia.org/wiki/Space","https://youtu.be/example","","MCQ","Story",1
"What planet is known as the Red Planet?","Venus","Mars","Jupiter","Saturn","B","","","","","","MCQ","Planets",1
"Type the answer: 5 + 5 = ?","","","","","10","Use your fingers!","","","","","TTA","Addition",3
"Sentence: The sun is \"hot\".","","","","","hot","It gives us heat.","","","","","FIB","Nature",4
```

### Field Descriptions:

- **Question**: The question text (required)
- **Answer A-D**: Answer options (required for MCQ)
- **Correct Answer**: 
  - For **MCQ**: The letter (A, B, C, D)
  - For **TTA** (Type The Answer): The exact text answer
  - For **FIB** (Fill In Blank): The word to fill in (optional, can be inferred from sentence)
- **Hint**: Floating hint text shown to the user (optional)
- **Know More Description**: Text for the "Know More" button (optional)
- **Know More Link**: URL to open when "Know More" is clicked (optional)
- **YouTube URL**: YouTube video ID or URL to show in a modal (optional)
- **Image URL**: URL of an image to display with the question (optional)
- **Type**: Question type (MCQ, TTA, FIB) (optional, auto-detected if empty)
- **Concept**: Subtopic or tagging for the question (optional)
- **Worksheet No.**: The worksheet number to group questions (required)
